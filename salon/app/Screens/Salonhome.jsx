...
const Salonhome = ({ username ,image }) => {
  ...
  const fetchSalons = async () => {
    try {
      const response = await instance.get('/admin/salons');
    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <TouchableOpacity onPress={handleProfileClick}>
          <Image
            source={{
              uri: `http://172.20.10.3:8000/uploads/${image}`,
            }}
 ...
 console.log('====================================');
  ...
  return (
    <TouchableOpacity
      ...
      onPress={() => {
        setSalon(salon);
        router.navigate('Screens/DetailsSalon',{salon});
      }}
    >
      <Image
        source={{ uri: `http://192.168.1.12:8000/uploads/${salon.image}` }}
      ...
      {isDrawerOpen && (
        <View style={styles.drawerContainer}>
          ...
          <View style={styles.profileInfo}>
            <Image
              source={{
                uri: `http://192.168.1.12:8000/uploads/${image}`,
              }}
